...
// when tokenType() is KEYWORD. Possible return values (in lower-case):
...
func print_tokenizer_token_info(tokenizer Tokenizer) {
...
func test_tokenizer(filepath string, folderpath string) {
	...
	// folderpath := "C:\\Users\\csfwn\\school\\Fundamentals\\Fundamentals-Lab-Work\\Fundamentals-Lab-Work\\Lab_5\\Tokenizer"
